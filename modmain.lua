...
modimport("scripts/whosphorus_from_rocks.lua")

Assets = {
    Asset( "IMAGE", "images/saveslot_portraits/waxbert.tex" ),
    Asset( "ATLAS", "images/saveslot_portraits/waxbert.xml" ),

    Asset( "IMAGE", "images/selectscreen_portraits/waxbert.tex" ),
    Asset( "ATLAS", "images/selectscreen_portraits/waxbert.xml" ),
	
    Asset( "IMAGE", "images/selectscreen_portraits/waxbert_silho.tex" ),
    Asset( "ATLAS", "images/selectscreen_portraits/waxbert_silho.xml" ),

    Asset( "IMAGE", "bigportraits/waxbert.tex" ),
    Asset( "ATLAS", "bigportraits/waxbert.xml" ),
	
	Asset( "IMAGE", "images/map_icons/waxbert.tex" ),
	Asset( "ATLAS", "images/map_icons/waxbert.xml" ),
	
	Asset( "IMAGE", "images/avatars/avatar_waxbert.tex" ),
    Asset( "ATLAS", "images/avatars/avatar_waxbert.xml" ),
	
	Asset( "IMAGE", "images/avatars/avatar_ghost_waxbert.tex" ),
    Asset( "ATLAS", "images/avatars/avatar_ghost_waxbert.xml" ),
	
	Asset( "IMAGE", "images/avatars/self_inspect_waxbert.tex" ),
    Asset( "ATLAS", "images/avatars/self_inspect_waxbert.xml" ),
	
	Asset( "IMAGE", "images/names_waxbert.tex" ),
    Asset( "ATLAS", "images/names_waxbert.xml" ),
	
	Asset( "IMAGE", "images/names_gold_waxbert.tex" ),
    Asset( "ATLAS", "images/names_gold_waxbert.xml" ),
	...
	Asset("ATLAS", "images/inventoryimages/paraffinwax.xml"),
    Asset("IMAGE", "images/inventoryimages/paraffinwax.tex"),
	...
	Asset("ATLAS", "images/inventoryimages/redwax.xml"),
    Asset("IMAGE", "images/inventoryimages/redwax.tex"),
	
	Asset("ATLAS", "images/inventoryimages/greenwax.xml"),
    Asset("IMAGE", "images/inventoryimages/greenwax.tex"),
	
	Asset("ATLAS", "images/inventoryimages/brownwax.xml"),
    Asset("IMAGE", "images/inventoryimages/brownwax.tex"),
	...
	Asset("ATLAS", "images/inventoryimages/esforestfruits.xml"),
    Asset("IMAGE", "images/inventoryimages/esforestfruits.tex"),
	...
	Asset("ATLAS", "images/inventoryimages/espumpkinroot.xml"),
    Asset("IMAGE", "images/inventoryimages/espumpkinroot.tex"),
	
	Asset("ATLAS", "images/inventoryimages/eswinterair.xml"),
    Asset("IMAGE", "images/inventoryimages/eswinterair.tex"),
	
	Asset("ATLAS", "images/inventoryimages/essummersolstice.xml"),
    Asset("IMAGE", "images/inventoryimages/essummersolstice.tex"),
	
	Asset("ATLAS", "images/inventoryimages/esfloweredcactus.xml"),
    Asset("IMAGE", "images/inventoryimages/esfloweredcactus.tex"),
	
	Asset("ATLAS", "images/inventoryimages/essweetlightness.xml"),
    Asset("IMAGE", "images/inventoryimages/essweetlightness.tex"),
	
	Asset("ATLAS", "images/inventoryimages/esrainbreeze.xml"),
    Asset("IMAGE", "images/inventoryimages/esrainbreeze.tex"),
	
	Asset("ATLAS", "images/inventoryimages/esdangersmell.xml"),
    Asset("IMAGE", "images/inventoryimages/esdangersmell.tex"),
	
	Asset("ATLAS", "images/inventoryimages/eswarsmell.xml"),
    Asset("IMAGE", "images/inventoryimages/eswarsmell.tex"),
	
	Asset("ATLAS", "images/inventoryimages/espepperspray.xml"),
    Asset("IMAGE", "images/inventoryimages/espepperspray.tex"),
	
	Asset("ATLAS", "images/inventoryimages/esmountainday.xml"),
    Asset("IMAGE", "images/inventoryimages/esmountainday.tex"),
	
	Asset("ATLAS", "images/inventoryimages/esburntgunpowder.xml"),
    Asset("IMAGE", "images/inventoryimages/esburntgunpowder.tex"),
	
	Asset("ATLAS", "images/inventoryimages/esdeadlyattraction.xml"),
    Asset("IMAGE", "images/inventoryimages/esdeadlyattraction.tex"),
	...
	Asset("ATLAS", "images/inventoryimages/waxremains.xml"),
    Asset("IMAGE", "images/inventoryimages/waxremains.tex"),
	
    Asset( "SOUNDPACKAGE", "sound/waxbert.fev" ),	
	Asset( "SOUND", "sound/waxbert.fsb" ),
}

RemapSoundEvent( "dontstarve/characters/waxbert", "waxbert/waxbert" )
RemapSoundEvent( "dontstarve/characters/waxbert/talk_LP", "waxbert/waxbert/talk_LP" )
RemapSoundEvent( "dontstarve/characters/waxbert/ghost_LP", "waxbert/waxbert/ghost_LP" )
RemapSoundEvent( "dontstarve/characters/waxbert/hurt", "waxbert/waxbert/hurt" )
RemapSoundEvent( "dontstarve/characters/waxbert/death_voice", "waxbert/waxbert/death_voice" )
RemapSoundEvent( "dontstarve/characters/waxbert/emote", "waxbert/waxbert/emote" )
RemapSoundEvent( "dontstarve/characters/waxbert/pose", "waxbert/waxbert/pose" )
RemapSoundEvent( "dontstarve/characters/waxbert/yawn", "waxbert/waxbert/yawn" )

AddMinimapAtlas("images/map_icons/waxbert.xml")
...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.WHOSPHORUS = "A light aroma of garlic."

AddRecipe("whosphorus",
{ Ingredient("rocks", 2), Ingredient("flint", 1)},
RECIPETABS.REFINE,
TECH.NONE,
nil,
nil,
...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.HANDSOMESTATUE = "You look very nice today!"

AddRecipe("handsomestatue",
{ Ingredient("meatwax", 1, "images/inventoryimages/meatwax.xml"), Ingredient("awakewax", 1, "images/inventoryimages/awakewax.xml"), Ingredient("marble", 4)},
RECIPETABS.SURVIVAL,
TECH.MAGIC_THREE,
"common/handsomestatue_placer",
nil,
nil,
nil,
"waxxxer", -- <- Custom character tag would go here if you wanted only that character to craft your item
