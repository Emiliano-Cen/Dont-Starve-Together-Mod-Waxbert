...
local function MainFunction()
    ...
    inst.components.edible:SetOnEatenFn(function(inst, eater)
        ...
        local cordura_amount = 4.8  -- Define la cantidad de cordura
        local cordura_duration = 25  -- Define la duración de la regeneración de cordura
        ...
        local healing_amount = 3.6  -- Define la cantidad de curación
        local healing_duration = 25  -- Define la duración de la curación
        ...
        -- Cancela la tarea periódica después de 25 segundos
        eater:DoTaskInTime(25, function()
            fx_task:Cancel()
        end)
        
		-- Inicia la generación de mariposas, abejas, cuervos o arañas
        local spawn_period = 7  -- Define el periodo de generación
        local spawn_duration = 25  -- Define la duración de la generación
        ...
        local function spawn_creatures(eater, spawn_count)
            ...
            -- Genera una mariposa, abeja, cuervo o araña
            local creature
