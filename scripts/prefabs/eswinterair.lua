local Assets = { 
    Asset("ANIM", "anim/eswinterair.zip"),
    Asset("ANIM", "anim/eswinterair_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("eswinterair.tex")
	
    inst.AnimState:SetBank("eswinterair_ground")
    inst.AnimState:SetBuild("eswinterair_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("eswinterair")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "eswinterair"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/eswinterair.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "eswinterair" end)
...
return  Prefab("common/inventory/eswinterair", MainFunction, Assets)
