local Assets = { 
    Asset("ANIM", "anim/espepperspray.zip"),
    Asset("ANIM", "anim/espepperspray_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("espepperspray.tex")
	
    inst.AnimState:SetBank("espepperspray_ground")
    inst.AnimState:SetBuild("espepperspray_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("espepperspray")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "espepperspray"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/espepperspray.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "espepperspray" end)
...
return  Prefab("common/inventory/espepperspray", MainFunction, Assets)
