local Assets = { 
    Asset("ANIM", "anim/brownwax.zip"),
    Asset("ANIM", "anim/brownwax_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("brownwax.tex")
	
    inst.AnimState:SetBank("brownwax_ground")
    inst.AnimState:SetBuild("brownwax_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("brownwax")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "brownwax"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/brownwax.xml"
    
    inst:AddComponent("edible")
    inst.components.edible.foodtype = FOODTYPE.GENERIC
    inst.components.edible.hungervalue = 56
    inst.components.edible.healthvalue = 46
...
return  Prefab("common/inventory/brownwax", MainFunction, Assets)