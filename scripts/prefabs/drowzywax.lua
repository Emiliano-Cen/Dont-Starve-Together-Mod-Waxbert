...
local function oneaten(inst, eater)
    if not eater:HasTag("waxxxer") then
        -- Si el consumidor no tiene la etiqueta "waxxxer", no permitas que consuma el ítem.
        return false
    end
...
local function MainFunction()
    ...
    inst.components.edible.healthvalue = 131 -- This line makes the item restore 8 health points when eaten.
