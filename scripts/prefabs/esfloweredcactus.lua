local Assets = { 
    Asset("ANIM", "anim/esfloweredcactus.zip"),
    Asset("ANIM", "anim/esfloweredcactus_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("esfloweredcactus.tex")
	
    inst.AnimState:SetBank("esfloweredcactus_ground")
    inst.AnimState:SetBuild("esfloweredcactus_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("esfloweredcactus")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "esfloweredcactus"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/esfloweredcactus.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "esfloweredcactus" end)
...
return  Prefab("common/inventory/esfloweredcactus", MainFunction, Assets)