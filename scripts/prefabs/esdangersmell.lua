local Assets = { 
    Asset("ANIM", "anim/esdangersmell.zip"),
    Asset("ANIM", "anim/esdangersmell_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("esdangersmell.tex")
	
    inst.AnimState:SetBank("esdangersmell_ground")
    inst.AnimState:SetBuild("esdangersmell_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("esdangersmell")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "esdangersmell"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/esdangersmell.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "esdangersmell" end)
...
return  Prefab("common/inventory/esdangersmell", MainFunction, Assets)
