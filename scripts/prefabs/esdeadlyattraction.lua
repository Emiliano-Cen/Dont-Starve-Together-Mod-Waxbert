local Assets = { 
    Asset("ANIM", "anim/esdeadlyattraction.zip"),
    Asset("ANIM", "anim/esdeadlyattraction_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("esdeadlyattraction.tex")
	
    inst.AnimState:SetBank("esdeadlyattraction_ground")
    inst.AnimState:SetBuild("esdeadlyattraction_ground")
    ...
    inst.components.inventoryitem.imagename = "esdeadlyattraction"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/esdeadlyattraction.xml"
...
return  Prefab("common/inventory/esdeadlyattraction", MainFunction, Assets)
