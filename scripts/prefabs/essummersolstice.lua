local Assets = { 
    Asset("ANIM", "anim/essummersolstice.zip"),
    Asset("ANIM", "anim/essummersolstice_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("essummersolstice.tex")
	
    inst.AnimState:SetBank("essummersolstice_ground")
    inst.AnimState:SetBuild("essummersolstice_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("essummersolstice")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "essummersolstice"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/essummersolstice.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "essummersolstice" end)
...
return  Prefab("common/inventory/essummersolstice", MainFunction, Assets)
