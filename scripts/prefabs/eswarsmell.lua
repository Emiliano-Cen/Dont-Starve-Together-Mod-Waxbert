local Assets = { 
    Asset("ANIM", "anim/eswarsmell.zip"),
    Asset("ANIM", "anim/eswarsmell_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("eswarsmell.tex")
	
    inst.AnimState:SetBank("eswarsmell_ground")
    inst.AnimState:SetBuild("eswarsmell_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("eswarsmell")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "eswarsmell"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/eswarsmell.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "eswarsmell" end)
...
return  Prefab("common/inventory/eswarsmell", MainFunction, Assets)