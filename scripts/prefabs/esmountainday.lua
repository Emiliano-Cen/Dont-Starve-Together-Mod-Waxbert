local Assets = { 
    Asset("ANIM", "anim/esmountainday.zip"),
    Asset("ANIM", "anim/esmountainday_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("esmountainday.tex")
	
    inst.AnimState:SetBank("esmountainday_ground")
    inst.AnimState:SetBuild("esmountainday_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("esmountainday")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "esmountainday"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/esmountainday.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "esmountainday" end)
...
return  Prefab("common/inventory/esmountainday", MainFunction, Assets)