local Assets = { 
    Asset("ANIM", "anim/esrainbreeze.zip"),
    Asset("ANIM", "anim/esrainbreeze_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("esrainbreeze.tex")
	
    inst.AnimState:SetBank("esrainbreeze_ground")
    inst.AnimState:SetBuild("esrainbreeze_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("esrainbreeze")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "esrainbreeze"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/esrainbreeze.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "esrainbreeze" end)
...
return  Prefab("common/inventory/esrainbreeze", MainFunction, Assets)
