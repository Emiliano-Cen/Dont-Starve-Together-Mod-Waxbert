local Assets = { 
    Asset("ANIM", "anim/esburntgunpowder.zip"),
    Asset("ANIM", "anim/esburntgunpowder_ground.zip"),
...
local function MainFunction()
    ...
    minimap:SetIcon("esburntgunpowder.tex")
	
    inst.AnimState:SetBank("esburntgunpowder_ground")
    inst.AnimState:SetBuild("esburntgunpowder_ground")
    inst.AnimState:PlayAnimation("anim")

    inst:AddTag("esburntgunpowder")
    inst:AddTag("waxxxer")
    ...
    inst.components.inventoryitem.imagename = "esburntgunpowder"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/esburntgunpowder.xml"
    ...
    inst:DoPeriodicTask(0.1, function(inst)
        ...
        if owner and owner:HasTag("player") and owner.prefab ~= "waxbert" then
            if owner.components.inventory then
                ...
                local items = owner.components.inventory:FindItems(function(item) return item.prefab == "esburntgunpowder" end)
...
return  Prefab("common/inventory/esburntgunpowder", MainFunction, Assets)